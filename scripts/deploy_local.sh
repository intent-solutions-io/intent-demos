...
mkdir -p "$deploy_root/about"
mkdir -p "$deploy_root/searchcarriers"
cp -f "$site_root/index.html" "$deploy_root/index.html"
cp -f "$site_root/about/index.html" "$deploy_root/about/index.html"
...
echo "Deployed catalog shell, About page, and the repository-owned SearchCarriers route to $deploy_root."
